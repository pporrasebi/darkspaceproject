...
STRING_mitab_25_url = "http://string.uzh.ch/download/protected/string_10/protein.links.full.v10/9606.protein.links.full.v10.txt.gz"
STRING_mitab_25_file_gz = "./source_files/9606.protein.links.full.v10.txt.gz"
STRING_mitab_25_file = "./source_files/9606.protein.links.full.v10.txt"
string_get = GET(STRING_mitab_25_url,  authenticate("pabloporras", "Rzpstqj3"))
string = content(string_get, type = "text/tab-separated-values")

if(!file.exists(STRING_mitab_25_file_gz)) download(STRING_mitab_25_url,STRING_mitab_25_file_gz, http_proxy_user)
gunzip(STRING_mitab_25_file_gz, remove = F)
...
STRING_proc[, ida_up := gsub("^string.+uniprotkb:","", ida)]
STRING_proc[, idb_up := gsub("^string.+uniprotkb:","", idb)]
...
# STRING_proc[, sort(table(database), decreasing = T)]
