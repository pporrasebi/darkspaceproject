...
## ----scrape_and_download_EVEX, message=FALSE, warning=FALSE--------------
...
EVEX_pairs_s = EVEX_pairs[, .(pair_id_clean, ida_clean, idb_clean, pubid, taxon, evex_score=interaction_confidence,EVEX)]
...
## ----biogrid_vs_imex, message=FALSE, warning=FALSE, fig.width=4, fig.height=2----
...
## ----biogrid_vs_imex_pub, message=FALSE, warning=FALSE, fig.width=4, fig.height=2----
...
## ----biogrid_vs_imex_pub_inter, message=FALSE, warning=FALSE, fig.width=4, fig.height=2----
