...
# gs_auth()
key <- extract_key_from_url("https://docs.google.com/spreadsheets/d/1tL1HtVD3-BxHxKuXbIYhcFjmCptGVEOD5aFJCZw6CZk/edit#gid=826915149")
...
Steps: 
 ...
 - Obtain mutation information from PubTator
        ...
        - Request example: `https://www.ebi.ac.uk/europepmc/annotations_api/annotationsByArticleIds?articleIds=MED%3A30497962%2CMED%3A24194929&type=Gene%20Mutations&provider=PubTator_NCBI&format=JSON`. The first publication here comes from a list geenrated through PubTator, so it should contain annotations, if I understood this right. But it does not. To bechecked with Aravind. 
...
To explore: the query as it is formulated does not import mesh terms for those PMIDs that either lack them or are reviews, but it also does not allow you to distinguish between the two cases. I need to re-do it takign this into account. DONE: Re-run pipeline with 10000 pmids and not only 100. 
