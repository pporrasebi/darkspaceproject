...
# dsp_curation <- data.table(gs_read(ss=dsp_manual, ws = "dsp_priority",header=T))
dsp_curation <- fread(
        "./source_data/Evaluating DSP - dsp_priority_rev_pred.tsv",
        check.names = T,
        sep = "\t",
...
dsp_curation$pmid <- as.character(dsp_curation$pmid)
```
