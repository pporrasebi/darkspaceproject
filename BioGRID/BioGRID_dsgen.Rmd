...
N_biogrid = length(biogrid_from_mentha[,unique(pair_id_clean)])
N_overlap = sum(!is.na(match(biogrid_from_mentha[,unique(pair_id_clean)], imex[taxid_a == "9606" | taxid_b == "9606", unique(pair_id_clean)])))
...
N_pubid_overlap = sum(!is.na(match(biogrid_from_mentha[,unique(pubid)], imex[taxid_a == "9606" | taxid_b == "9606", unique(pubid)])))
...
N_pub_int_overlap = sum(!is.na(match(biogrid_from_mentha[,unique(paste0(pubid,"_",pair_id_clean))], imex[taxid_a == "9606" | taxid_b == "9606", unique(paste0(pubid,"_",pair_id_clean))])))
