...
I download the latest version of the BioGRID data from mentha using PSICQUIC. The file was downloaded on `r BioGRID_mentha_date`. 
...
`r nrow(biogrid_pmids)` publications are curated into BioGRID. 
